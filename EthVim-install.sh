...
autocmd filetype cpp nnoremap <F2> :w<CR>:exec '!mkdir -p ./bin && g++ --std=c++17 -finput-charset=UTF-8 -fexec-charset=GBK '.shellescape('%').' -o ./bin/'.shellescape('%:r').' && ./bin/'.shellescape('%:r')<CR>
